...
import ru.netology.nmedia_server.dto.Comment
...
import ru.netology.nmedia_server.service.CommentService
...
class NMediaApplication {
    ...
    fun runner(
        ...
        val noname = authorService.save(
            Author(id=0, name="Студент", avatar="noname.png")
        )
